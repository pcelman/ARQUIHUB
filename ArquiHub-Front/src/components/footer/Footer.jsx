    ...
    >
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul class="text-gray-300 text-opacity-50 dark:text-gray-300 ">
              ...
              <li>
                <a
                  href="https://discord.gg/YwPGpCFD"
                  target="blank"
                  class="hover:underline"
                >
                  Discord
      ...
      <div class="sm:flex sm:items-center sm:justify-evenly">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="https://www.youtube.com/channel/UCWezpYsz1s5QUMH8-OK4FBQ/featured"
            class="text-gray-500 hover:text-gray-100 dark:hover:text-white"
          >
            <FontAwesomeIcon icon={faYoutube} className="text-xl"/>
          </a>
          <a
            href="https://www.instagram.com/arquihub06/"
            class="text-gray-500 hover:text-gray-100 dark:hover:text-white"
          >
            <svg
              class="w-5 h-5"
          ...
          <a
            href="https://twitter.com/ArquiHub"
            class="text-gray-500 hover:text-gray-100 dark:hover:text-white"
          >
            <svg
              class="w-5 h-5"
